...
{
    public class GetEventsExportQueryHandler(IMapper mapper, IAsyncRepository<Event> eventRepository, ICsvExporter csvExporter) : IRequestHandler<GetEventsExportQuery, EventExportFileVm>
    {
